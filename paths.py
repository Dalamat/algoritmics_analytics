...
file_events = envs.file_events
file_groups = envs.file_groups
file_invoices = envs.file_invoices
file_students = envs.file_students
file_events_filter = envs.file_events_filter
file_invoices_filter = envs.file_invoices_filter
file_students_filter = envs.file_students_filter

# Generate paths for the source files
events_csv_path = os.path.join(active_folder, file_events)
groups_csv_path = os.path.join(active_folder, file_groups)
students_csv_path = os.path.join(active_folder, file_students)
invoices_csv_path = os.path.join(active_folder, file_invoices)
...
output_path_events = os.path.join(active_folder,file_events)
output_path_groups = os.path.join(active_folder,file_groups)
output_path_invoices = os.path.join(active_folder,file_invoices)
output_path_students = os.path.join(active_folder,file_students)
output_path_events_filter = os.path.join(active_folder,file_events_filter)
output_path_invoices_filter = os.path.join(active_folder,file_invoices_filter)
output_path_students_filter = os.path.join(active_folder,file_students_filter)