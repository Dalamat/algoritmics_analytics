"""Added Central_OP_Status to Leads view

Revision ID: 95edcc5a7c39
Revises: 14e1fdee8a52
Create Date: 2023-09-11 11:35:30.711398
...
revision = '95edcc5a7c39'
down_revision = '14e1fdee8a52'
branch_labels = None
depends_on = None


def upgrade() -> None:
    # Drop leads_view view
    op.execute("""
