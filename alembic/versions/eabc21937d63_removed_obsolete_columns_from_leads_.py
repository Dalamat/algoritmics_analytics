"""Removed obsolete columns from leads table and view

Revision ID: eabc21937d63
Revises: e337bb785e10
Create Date: 2023-09-23 13:19:21.255388
...
revision = 'eabc21937d63'
down_revision = 'e337bb785e10'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.execute("""
        CREATE TABLE public.leads (
            ...
            "Причина отказа ОП" varchar(255) NULL,
            ...
            "backoffice_id" varchar(255) NULL
        );
    """)
    ...
    CREATE VIEW public.leads_view AS
        ...
        "Cтатус в ЦОП" as "Cтатус в ЦОП",
        "Причина отказа ОП" as "Причина отказа ОП",
        Телефон AS "Телефон",
        ...
        Педагог AS "Педагог",
        "Дата МК" AS "Дата МК",
        "Мастер-класс_Дата_время" AS "Мастер-класс_Дата_время",
        ...
        "backoffice_id" as "backoffice_id"
        FROM public.leads;
    ''')
    pass
...
def downgrade() -> None:
    ...
    op.execute("""
        CREATE TABLE public.leads (
            ...
            "backoffice_id" varchar(255) NULL,
            "лид из телефонии?" varchar(255) NULL,
