"""Added new columns to leads table and view

Revision ID: e337bb785e10
Revises: 95edcc5a7c39
Create Date: 2023-09-17 22:52:12.123324
...
revision = 'e337bb785e10'
down_revision = '95edcc5a7c39'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    # Drop leads table leads_view view
    op.execute("""
        DROP VIEW public.leads_view;
        DROP TABLE public.leads;
    """)
