...
def get_urls(table):
    ...
    if table == "invoices_filter":
        ...
        return bo_csv_url_invoices_filter
    elif table == "students_filter":
        ...
        return bo_csv_url_students_filter
    elif table == "payments_filter":
        ...
        return bo_csv_url_payments_filter
